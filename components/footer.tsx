      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-8 items-start">
          ...
          <div className="sm:text-right">
            <Link href="/jo" className="text-xl font-bold text-white inline-flex items-center gap-0 mb-2">
        ...
        <div className="border-t border-slate-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-slate-400">© 2026 Jo from Corp. All rights reserved.</p>
